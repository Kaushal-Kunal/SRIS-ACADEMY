...
@Component({
  selector: 'app-batch-by-report',
  templateUrl: './batch-by-report.component.html',
  styleUrls: ['./batch-by-report.component.css']
})
export class BatchByReportComponent implements OnInit {
  ...
  onAttendance(row: any) {
    ...
    this.router.navigate(['institutehome/attendancereport'])
  }
